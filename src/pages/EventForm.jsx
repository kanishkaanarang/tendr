...
const EventPlanningForm = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      type: 'select',
      options: ['Get-together', 'Birthday', 'Office Party', 'Concert', 'Anniversary', 'Pre Wedding', 'Rituals', 'Festival', 'Others'],
      icon: <Calendar className="w-8 h-8" />
    },
    {
      id: 'guests',
  ...
  // To Close a Service Type dropdown
  const closeModal = () => {
    setActiveModal(null);
  };
          ...
          <div className="text-center">
            ...
            <div className="btn flex justify-center">
              ...
              >
                ...
                >
                  <EastIcon className="text-white group-hover:text-[#ea7e53] transition duration-300" fontSize="medium" />
                </span>
              </button>
            </div>
          </div>
