...
//IMRPOVE BANNER ON HERO SECTION, NINJFONTS EFFECT
//FONTS CHANGE
//IMRPOVE IMAGE QUALITY FOR EACH IMAGE CHANGE PARAMETERS SUCH AS SATURATION, CONTRAST, ETC
//TEXT CENTER IN WE CURATE YOU CELEB
//ADD SERVICE NAME,CURSOR-POINTER,ZOOM AND MOVE UP A BIT EFFECT EFFECT IN RECOMMEND VENDORS
//ADD BG-COLOR CHANGE EFFECT ON QUESTIONS WHEN HOVERED
//WHEN HOVERED ON RECOMMENDED VENDROS IMAGES THE ROUNDNESS SHOULD CHANGE
//ADD CURSOR POINTER CLASS IN PLACES WHERE IT HASNT BEEN USED
//DELETE OLD LANDING PAGE, COMPONENTS AND IMAGES ASSOCIATED WITH IT
//ADD DROPDOWN TRANSITIONS AND ANIMATIONS IN QUESTIONS
