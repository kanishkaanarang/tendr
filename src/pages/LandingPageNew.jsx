    ...
    return (
        <>
            <div className='h-fit relative'>
                ...
                >
                    <div
                        className="text-white font-bold text-4xl md:text-6xl lg:text-[120px] transition-transform duration-300 ease-in-out group-hover:-translate-y-2 group-hover:scale-110"
