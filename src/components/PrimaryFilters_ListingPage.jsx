...
const PrimaryFilters_ListingPage = ({
  ...
  return (
    <>
      <div className="primary_heading ml-12 font-bold text-2xl">
        Event Details
      </div>
      ...
      <div className="primary_filter_options flex flex-col gap-4 mt-4 items-center w-full">
        ...
        <div className="event flex flex-col text-sm w-[85%] max-w-[450px] relative">
          <label
            className="font-semibold text-[14px] cursor-pointer ml-3"
            onClick={() => {
              ...
              {eventOptions.map((option, index) => {
                return (
                  <div
                    ...
                    className={`cursor-pointer text-sm p-2 pl-7 ml-5 mr-5 mt-2 mb-2 rounded-[15px] font-medium text-black ${
                      eventType === option
                        ? "bg-[#fbc0105e]"
                        : "hover:bg-[#ffe79e45]"
                    }`}
      ...
      <div className="search_btn flex justify-center mt-6">
        ...
        >
          ...
          <span className="group-hover:bg-white arrowButton w-[30px] h-[30px] bg-[#CCAB4A] rounded-xl flex items-center justify-center transition duration-300">
            <EastIcon
              className="text-white group-hover:text-[#CCAB4A] transition duration-300"
              fontSize="medium"
            />
          </span>
        </button>
